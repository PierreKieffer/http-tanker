...
Edit
*/
func SuggestData(reqName string) []string {
...
func (app *App) Edit(reqName string) error {
	var menu = &survey.Editor{
		Message:  "Edit : ",
		FileName: "/Users/pierre/http-tanker/http-tanker-data.json",
	}
	...
	err := survey.AskOne(menu, &genericAnswer)

	if err != nil {
		return err
	}
	fmt.Println(genericAnswer.Edit)
	return nil
